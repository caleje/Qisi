...
object Entries {
  ...
  private lazy val enLines = scala.io.Source.fromInputStream( enStream ).getLines.toIndexedSeq
  ...
  private lazy val chLines = scala.io.Source.fromInputStream( chStream ).getLines.toIndexedSeq
